...
<style>
 ...
 margin-bottom:5px;
    ...
    <script type="text/javascript">
        $(function(){
        	$("#li5 a").attr("style","color:#0ae");
        	$("div .title").html("批量退款订单查询(rest/queryRefunds)");
        	var date = new Date();
...
<body>
    ...
    <div class="content" style="height:1150px;">
        <form action="merchant_ref_batchqry_api.jsp" class="alipayform" method="POST" target="_blank">
            <div class="element" style="margin-top:60px;">
                <div class="legend">批量退款订单查询 </div>
            </div>
            <div class="element">
            ...
            <div class="element">
                ...
                <div class="einput"><input type="text" name="refund_no"  maxlength="32"></div>
                <br>
                <div class="mark">提示： 发起退款时填写的退款单号</div>
            </div>
           ...
           <div class="element">
               <div class="mark" >其他说明：bill_no, refund_no, start_time, end_time等查询条件互相为<font color='red'>且</font>关系 <br/>
