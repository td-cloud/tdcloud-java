...
public class TestConstant {
    ...
    public static String ALI_TRANSFER_ACCOUNT_NAME = "测试名称科技有限公司";
    ...
    public static String ALI_TRANSFER_RECEIVER_NAME_1 = "李某某";
    public static String ALI_TRANSFER_RECEIVER_NAME_2 = "王某某";
    ...
    public static String yeeWebReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/yeeWebReturnUrl.jsp";
    public static String yeeWapReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/yeeWapReturnUrl.jsp";
    public static String jdWebReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/jdWebReturnUrl.jsp";
    public static String jdWapReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/jdWapReturnUrl.jsp";
    public static String kqReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/kqReturnUrl.jsp";
    public static String aliReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/aliReturnUrl.jsp";
    public static String unReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/unReturnUrl.jsp";
    public static String bdReturnUrl = "http://localhost:8080/Tdcloud-PC-Demo/bdReturnUrl.jsp";
    ...
    public static String MOCK_SANDBOX_PAY_URL = "http://mock.tdcoloud.cn/testcase/?appid=c5d1cba1-5e3f-4ba0-941d-9b0a371fe719&channel=ALI_WEB&objectid=56f05148-f84d-461b-934a-996abe22e72e&title=demo%E6%B5%8B%E8%AF%95&fee=1&bill_no=d520c0237c9643eb9440a8cd0b094c55";
    ...
    public final static String LIMIT_FORMAT_INVALID = "number 的最大为200！";
    ...
    public static String ASSERT_MESSAGE_TCEXCEPTION_NOT_THROWN = "TCException未抛出！";
    public static String ASSERT_MESSAGE_TCEXCEPTION_THROWN = "TCException抛出";
    ...
    public static String MOCK_APP_INVALID_ERRMSG = "app_id不存在或无效，请检查参数！";
